...
import database
from config import ADMINS, CHANNEL_ID, CHANNELS, EXCLUDE_DOMAIN, FOOTER_TEXT, HEADER_TEXT, MDISK_API, SHORTURLLINK_API, INCLUDE_DOMAIN, USERNAME
...
class Helpers:
    ...
    @property
    async def user_shorturllink_api(self):
        return SHORTURLLINK_API
